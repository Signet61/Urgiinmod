...
<div class="glass rounded-3xl shadow-2xl p-7 mb-4">
    ...
    <div class="flex gap-3 justify-center flex-wrap mt-5">
        <a href="{{ route('family-tree') }}"
           class="font-bubblegum text-xl px-10 py-3 bg-green-500 hover:bg-green-400 text-white rounded-full no-underline transition-transform hover:-translate-y-1 active:translate-y-0.5"
           style="box-shadow:0 5px 0 #388e3c">
            🌳 Ургийн мод харах
        </a>
        <a href="{{ route('game') }}"
           class="font-bubblegum text-xl px-10 py-3 bg-orange-400 hover:bg-orange-300 text-white rounded-full no-underline transition-transform hover:-translate-y-1 active:translate-y-0.5"
...
<div class="glass rounded-3xl shadow-xl p-6 text-center">
    ...
    <a href="{{ route('dashboard') }}"
       class="font-bubblegum text-lg px-8 py-2.5 bg-blue-400 hover:bg-blue-500 text-white rounded-full no-underline transition-transform hover:-translate-y-0.5 inline-block"
...
<div class="glass rounded-3xl shadow-xl p-6">
    ...
    <div class="flex gap-3 justify-center flex-wrap">
        <a href="{{ route('login') }}"
           class="font-bubblegum text-lg px-8 py-2.5 bg-purple-400 hover:bg-purple-500 text-white rounded-full no-underline transition-transform hover:-translate-y-0.5"
           style="box-shadow:0 4px 0 #6a1b9a">
            🔑 Нэвтрэх
        </a>
        <a href="{{ route('register') }}"
           class="font-bubblegum text-lg px-8 py-2.5 bg-pink-400 hover:bg-pink-500 text-white rounded-full no-underline transition-transform hover:-translate-y-0.5"
